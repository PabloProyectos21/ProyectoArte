...
@include('components.sidebar')
    ...
    <!-- 🎥 VIDEO DE FONDO desde URL -->
        ...
        <!-- 🧾 Contenido principal -->
        @guest
            <div class="relative z-20 flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-8 py-20 sm:py-28 ">
            ...
            <div id="text-carousel" class=" w-full" data-carousel="slide">
                ...
                <div class="overflow-hidden relative h-56 mt-24 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                    <!-- Slide 1 -->
                    <div class="hidden z-40 duration-700 bg-blue-400 ease-in-out" style="height: 170px" data-carousel-item>
                    ...
                    <!-- Slide 2 -->
                    <div class="hidden z-30 duration-700 bg-red-400 ease-in-out" style="height: 170px" data-carousel-item>
                    ...
                    <!-- Slide 3 -->
                    <div class="hidden z-10 duration-700 bg-purple-500 ease-in-out" style="height: 170px" data-carousel-item>
                        <div class="flex items-center justify-center h-full  dark:">
                            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
        ...
        @auth
            <div class="relative z-20 flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-8 py-20 sm:py-28 ">
                ...
                <a href="{{route('users.explore')}}" class="inline-block px-5 sm:px-6 py-3 text-base sm:text-lg font-medium bg-blue-400 hover:bg-purple-700 rounded-lg transition">
                    {{ __('Explore users') }}
                </a>
            </div>
